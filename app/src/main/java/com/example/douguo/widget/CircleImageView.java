package com.example.douguo.widget;
...
/**
 * Created by huang on 2015/11/18.
 */
public class CircleImageView extends ImageView {
    ...
    private int mBorderInsideColor = Color.WHITE;
    // 控件默认长、宽
    ...
    public CircleImageView(Context context, AttributeSet attrs) {
        ...
        mBorderThickness = a.getInt(R.styleable.CircleImageView_border_width,3);
        a.recycle();
    }
